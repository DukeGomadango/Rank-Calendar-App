  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-3xl flex-col gap-6 bg-background px-4 py-12 text-sm leading-relaxed text-zinc-800 dark:text-zinc-200">
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第1条（サービス定義）</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第2条（利用条件）</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第3条（禁止行為）</h2>
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第4条（コンテンツ・データの取り扱い）</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第5条（免責）</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第6条（サービスの変更・停止）</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第7条（規約の変更）</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="mt-8 border-b border-zinc-200 pb-1 text-base font-bold dark:border-zinc-700">第8条（準拠法・管轄）</h2>
        <p>
